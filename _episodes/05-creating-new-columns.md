...
In the Farms table, the three columns A01_interview_date, A04_start and A05_end are all recognisable as dates with the A04_srtart and A05_end also including times.
...
biggist, we can make this explicit by using the `ASC` keyword. Or if we want to
